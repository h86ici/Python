...
class Programmer(Employee):
    ...
    def __init__(self, name, title, working_hour=0):
...
class Salesman(Employee):
    ...
    def __init__(self, name, title, sales=0):
        super().__init__(name, title)
        self._sales = sales
...
def main():
    ...
    emps = [Manager('劉一', 'Manager'), Programmer('諸二', 'Programmer'), Manager('曹三', 'Manager'), Salesman('荀四', 'Salesman')] 
